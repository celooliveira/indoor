          ...
          <div class="modal-dialog">
            <div class="modal-content">
              <div class="modal-header">
                ...
                <h3 class="modal-title">Cadastro de clientes</h3>
              </div>
              <div class="modal-body">
                <form class="form-horizontal">
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                        <input type="text" class="form-control" id="codigo" maxlength="10" placeholder="Código">
                      </div>
                    </div>
                    <div class="form-group">
                        <label for="" class="col-sm-3 control-label">Fantasia</label>
                        <div class="col-sm-8">
                        <input type="text" class="form-control" id="fantasia" maxlength="25" placeholder="Nome fantasia..">
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="" class="col-sm-3 control-label">Nome</label>
                        <div class="col-sm-8">
                        <input type="text" class="form-control" id="nome" maxlength="50" placeholder="Nome do cliente..">
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="" class="col-sm-3 control-label">Fantasia</label>
