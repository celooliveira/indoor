      ...
      <ul class="sidebar-menu">
		...
		<li class="header">Cadastros</li>
			...
			<ul class="treeview-menu">
				...
				<li><a href="estados.php"><i class="fa fa-dashboard"></i> <span>Cidades</span></a></li>
				<li><a href="estados.php"><i class="fa fa-dashboard"></i> <span>Bairros</span></a></li>
				<li><a href="estados.php"><i class="fa fa-dashboard"></i> <span>Cadastros Gerais</span></a></li>
				<li><a href="estados.php"><i class="fa fa-dashboard"></i> <span>Prod/Serv/Equip</span></a></li>
      ...
      <div class="col-sm-6 col-md-4">
        ...
        <div class="box box-success">
          <div class="box-header with-border">
            <h4 class="box-tittle"><i class="fa fa-graduation-cap"></i> Estados</h4>
...
<script src="addfile/data-teste.js"></script>
